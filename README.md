...
This content is designed for participants who possess the following skills and experience:

- **Platform Proficiency**
  - Python programming
  - Foundational Knowledge of Databricks Platform, including Unity Catalog
...
- Go to the [AGENDA](./Get%20Started%20with%20AgentBricks%20KA%20on%20Databricks/AGENDA.py) (warning: Databricks notebook, not pure markdown)
